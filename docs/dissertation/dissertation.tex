...
\begin{document}
    ...
    % Output here because we need to know what is expected before discussing any processing
    % An SVG Video that is of course highly scalable and has a lower size than the original if upscaled and with
    % very minimal data loss (frame based still)
    ...
    \sentence
    Many more compression optimizations can be done in the future in this step to further reduce the size of the final
