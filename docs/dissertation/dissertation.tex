...
\begin{document}
    ...
    but can also be seen as an artistic style choice as shown in Cartoon Network's \textit{Ed, Edd n Eddy}.
    \sentence
    ...
    \sentence
    An example of a real world cartoon that has these ideal qualities is Nickelodeon's \textit{The Fairly OddParents}
    ...
    \sentence
    Examples include Hanna Barbera cartoons prominent from the 1960s to the 1980s such as \textit{Top Cat} and
    \textit{The Flinstones}, \textit{Looney Tunes} cartoons as well as modern 3D animations such as Pixar Animation
    Studios' \textit{Toy Story} and \textit{The Incredibles}.
    \sentence
