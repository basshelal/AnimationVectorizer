...
\begin{document}
    ...
    \sentence
    The first toolchain that comes to mind is the JVM platform with its large thriving ecosystem, multiple languages
    ...
    qualities that seem favorable towards vectorization.
    \sentence
    In knowing this beforehand one may face less frustrations and better expectations on what it means to achieve any
